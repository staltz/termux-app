...
public final class TermuxVRViewClient implements TerminalViewClient {

    final TermuxVRActivity mActivity;

    /** Keeping track of the special keys acting as Ctrl and Fn for the soft keyboard and other hardware keys. */
    boolean mVirtualControlKeyDown, mVirtualFnKeyDown;

    public TermuxVRViewClient(TermuxVRActivity activity) {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e, TerminalSession currentSession) {
        ...
        if (keyCode == KeyEvent.KEYCODE_ENTER && !currentSession.isRunning()) {
            ...
            if (keyCode == KeyEvent.KEYCODE_DPAD_DOWN || unicodeChar == 'n'/* next */) {
                ...
                // FIXME: No drawers in VR
            } else if (keyCode == KeyEvent.KEYCODE_DPAD_LEFT) {
                // FIXME: No drawers in VR
            } else if (unicodeChar == 'f'/* full screen */) {
                // FIXME: No need in VR? Should we just switch to non-vr app instead?
                ...
                TermuxService service = mActivity.mTermuxService;
                    ...
                    if (codePointLowerCase == shortcut.codePoint) {
                        switch (shortcut.shortcutAction) {
                            ...
                            case TermuxPreferences.SHORTCUT_ACTION_RENAME_SESSION:
                                // FIXME: How to rename sessions in vr?
